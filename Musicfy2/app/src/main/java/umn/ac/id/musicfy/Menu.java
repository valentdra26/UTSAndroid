...
import umn.ac.id.musicfy.MusicFiles;
...
public class Menu extends AppCompatActivity {
    ...
    private void permission() {
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(Menu.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}
                    , REQUEST_CODE);
        }else {
    ...
    protected void onStart() {
        ...
        builder.setTitle("Welcome").setMessage("Renaldo Valentdra" + "\n" + "00000029627").setPositiveButton("Close",
